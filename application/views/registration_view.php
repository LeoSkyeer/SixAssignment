...
<div class="col-md-12">
  <div class="well" style="margin-top: 0%; background-color:lightgrey">
        ...
        <form role="form" id="contactForm"  class="shake" action="" method="POST" enctype="multipart/form-data">
            <!-- Имя -->
            <div class="row">
                <div class="form-group col-sm-12">
                    <label for="name" class="h4">Имя</label>
                    <input name="user_name" type="text" class="form-control" id="name" placeholder="Введите свое имя" ><span></span><!-- data-error="Забыли как вас зовут?" required pattern="^[А-Яа-яЁё\s]+$"-->
            ...
            <div class="row">
                <div class="form-group col-sm-12">
                    ...
                    <input name="user_age" type="text" class="form-control" id="age" placeholder="Введите ваш возраст" ><span></span> <!-- data-error="Забыли сколько вам лет?" required pattern="^[ 0-9]+$" -->
                    <div class="help-block with-errors"></div>
                </div>
            </div>
...
<!--            email-->
            <div class="row">
                <div class="form-group col-sm-12">
                    ...
                    <input name="user_email" type="text" class="form-control" id="mail" placeholder="E-mail" ><span></span> <!--< data-error="Забыли сколько вам лет?" required pattern="^[ 0-9]+$"> -->
                    <div class="help-block with-errors"></div>
                </div>
            </div>
...
<!--            </div>-->
            ...
            <div class="form-group col-sm-12">
                ...
                <textarea name="user_message" id="message" class="form-control" rows="5" placeholder="Напишите немного о себе" ></textarea> <span></span>
            </div>
            </div>
